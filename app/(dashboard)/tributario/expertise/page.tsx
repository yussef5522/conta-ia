...
// Sprint 5.0.2.b — Página de análise expert por CNAE.
...
export default function ExpertisePage() {
  const { currentEmpresaId, currentEmpresa } = useEmpresa()
  ...
  async function calcular() {
    ...
    if (!profileCNAE) {
      toast({
        ...
        description: 'Vá em Perfil Fiscal e selecione um CNAE.',
      })
      return
    }
    setCalculating(true)
  ...
  return (
    <div className="space-y-6">
      <Header
        ...
        description={
          currentEmpresa
            ? `Análise expert por ramo de atividade — ${currentEmpresa.name}`
            : 'Análise expert por ramo de atividade'
        }
      >
        <DisclaimerInfo />
        ...
        <CardContent className="space-y-4">
          {!profileCNAE && (
            <div className="rounded-md bg-amber-50 border border-amber-200 p-3 text-sm text-amber-900">
              ...
              <Link href="/tributario/perfil" className="underline">
                Configurar agora
              </Link>
              .
            </div>
            ...
            <Card>
              ...
              <CardContent className="space-y-3">
                {analysis.recomendacoes.map((r) => (
                  <div key={r.prioridade} className="flex items-start gap-3 pb-3 border-b last:border-b-0">
            ...
            <Card>
              ...
              <CardContent className="space-y-3">
                {analysis.otimizacoes.map((o, i) => (
                  <div key={i} className="rounded-md bg-emerald-50/50 border border-emerald-100 p-3">
              ...
              {analysis.beneficiosAplicaveis.map((b, i) => (
                <details key={i} className="rounded-md border bg-white">
                  <summary className="cursor-pointer px-3 py-2 flex items-center justify-between gap-3">
                    ...
                    <span className="text-xs text-emerald-700 shrink-0">{b.economiaPotencial}</span>
                  </summary>
