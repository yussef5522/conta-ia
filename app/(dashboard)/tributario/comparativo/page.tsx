...
// Sprint 5.0.2 — Comparativo entre Simples Nacional, Lucro Presumido e Real.

import { useEffect, useState } from 'react'
import Link from 'next/link'
import { ChevronLeft, Trophy, TrendingDown, AlertCircle, Loader2 } from 'lucide-react'
...
export default function ComparativoPage() {
  ...
  const [atividade, setAtividade] =
    useState<TaxCompareInput['atividade']>('SERVICOS')
  ...
  // Pré-carrega perfil se já existir
  useEffect(() => {
  ...
  return (
    <div className="space-y-6">
      <Header
        ...
        description="Simples Nacional × Lucro Presumido × Lucro Real"
      >
        <DisclaimerInfo />
        ...
        <CardContent className="py-5 space-y-3">
          <div className="grid gap-3 sm:grid-cols-2 lg:grid-cols-3">
            ...
            <div className="space-y-1.5">
              ...
              <Select value={atividade} onValueChange={(v) => setAtividade(v as TaxCompareInput['atividade'])}>
            ...
            <div className="space-y-1.5 flex flex-col justify-end gap-2">
              <label className="flex items-center gap-2 text-sm">
                <Checkbox
                  checked={hasICMS}
                  onCheckedChange={(v) => setHasICMS(!!v)}
                />
