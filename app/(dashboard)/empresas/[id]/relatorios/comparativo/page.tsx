// Sprint 5.0.4.0a (a2) — Comparativo 3 Meses.
...
export const metadata: Metadata = { title: 'Comparativo Mensal — Relatórios' }
  ...
  return (
    <div className="space-y-4">
      ...
      <Header
        ...
        description={`Veja o que mudou em 3 meses — ${empresa.tradeName ?? empresa.name}`}
      />

      <ComparativoClient empresaId={empresaId} />
    </div>
  )
}
