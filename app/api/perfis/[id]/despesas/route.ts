...
//
// GET /api/perfis/[id]/despesas?de=YYYY-MM-DD&ate=YYYY-MM-DD&sourceFilter=&onlyBridgeSpend=&bankAccountId=&creditCardId=
//
// Retorna breakdown + cashflow em uma única chamada (usado pelo client
// pra refetch quando filtros mudam).
...
export async function GET(
  ...
  try {
    ...
    const [breakdown, cashflow] = await Promise.all([
      getPersonalExpenseBreakdown(inputBase),
