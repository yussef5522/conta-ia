// A ação de `iniciar` na janela da cozinha. O PIN volta em toda ação: o servidor resolve
...
import { iniciarTarefa, minhasTarefasDeHoje, TarefaError } from '@/lib/stock/producao/minhas-tarefas'
...
export async function POST(request: NextRequest, { params }: Params) {
  ...
  try {
    await iniciarTarefa({ companyId, etapaId: parsed.data.etapaId, colaboradorId: quem.colaboradorId }, prisma)
  } catch (e) {
